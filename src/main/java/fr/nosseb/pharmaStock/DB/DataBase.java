...
public class DataBase {
    ...
    private static final String DRIVER_URL_SUFFIX = ";create=true";
    ...
    public static void connect(String db_path) {
        // Assemble DB URL.
        DRIVER_URL = DRIVER_URL_PREFIX + db_path + DRIVER_URL_SUFFIX;
        ...
        try {
            ...
            // EXCEPTION : transmit exception generated by accessed class (here the driver's class).
